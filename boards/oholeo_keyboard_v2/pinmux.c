...
void init_spi1_pins_with_gpio_as_cs(void)
{
    ...
    HPM_IOC->PAD[IOC_PAD_PA30].PAD_CTL = IOC_PAD_PAD_CTL_SR_SET(1) | IOC_PAD_PAD_CTL_SPD_SET(3);

    HPM_IOC->PAD[IOC_PAD_PA31].FUNC_CTL = IOC_PA31_FUNC_CTL_SPI1_DAT3;
    HPM_IOC->PAD[IOC_PAD_PA31].PAD_CTL = IOC_PAD_PAD_CTL_SR_SET(1) | IOC_PAD_PAD_CTL_SPD_SET(3);
}
