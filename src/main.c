...
int main(void)
{
    ...
    while (1)
    {
        ...
        /*
        printf("[%ld] %ld\t%lf\t%lf\t%lf\t%d\t%d\t%d\t%d\t%d\t%d\t%d\n",
          g_keyboard_tick,
          debug1,
          (double)(start_time),
          (double)(end_time1),
          (double)(end_time),
          g_keyboard_advanced_keys[6].raw/8,
          g_keyboard_advanced_keys[23].raw/8,
          g_keyboard_advanced_keys[22].raw,
          g_keyboard_advanced_keys[24].raw,
          g_keyboard_advanced_keys[1].raw,
          g_keyboard_advanced_keys[0].raw,
          g_keyboard_advanced_keys[16].raw);
          */
